...
//import com.hyunjoying.cyworld.IntegrationTest;
...
//    private User testIlchon;
//    private User testStranger;
//
...
//    @BeforeEach
//    void setUp() {
//        super.integrationTestSetup();
//
//        testUser = User.builder()
//                .loginId("testUser").password(passwordEncoder.encode("1234")).name("테스트유저")
...
//                .loginId("friend1").password(passwordEncoder.encode("1234")).name("테스트일촌")
...
//                .loginId("stranger").password(passwordEncoder.encode("1234")).name("방문자")
//                .email("stranger@test.com").phone("010-9999-9999").birth("2000-01-01")
//                .gender(User.Gender.FEMALE).build();
//        userRepository.save(testStranger);
//        minihomeRepository.save(new MiniHomepage(testStranger));
//
